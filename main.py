...
print("Running in Alembic:", "alembic" in traceback.format_stack()[-1].lower())  # Debug with stack trace
...
# Defer Telegram setup to app startup
def setup_telegram():
    global application
    if TELEGRAM_TOKEN:  # Only setup if token is provided
        application = Application.builder().token(TELEGRAM_TOKEN).build()
        # Define handlers inside setup_telegram
